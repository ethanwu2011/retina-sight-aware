...
const FutureOutlook = () => {
  ...
  const data = [
    ...
    { year: 2025, cases: 102, deaths: 99, label: "Development + Preclinical Research" },
    { year: 2026, cases: 104, deaths: 98, label: "Development + Preclinical Research" },
    { year: 2027, cases: 106, deaths: 97, label: "Clinical Validation Trials" },
    { year: 2028, cases: 108, deaths: 96, label: "Clinical Validation Trials" },
    { year: 2029, cases: 110, deaths: 95, label: "FDA Submission and Review" },
    { year: 2030, cases: 112, deaths: 94, label: "FDA Submission and Review" },
    { year: 2031, cases: 115, deaths: 93, label: "FDA Approval" },
    { year: 2032, cases: 130, deaths: 85, label: "Post-Market Surveillance (Ongoing)" },
    { year: 2033, cases: 145, deaths: 78, label: "Post-Market Surveillance (Ongoing)" },
    { year: 2034, cases: 155, deaths: 72, label: "Post-Market Surveillance (Ongoing)" },
    { year: 2035, cases: 160, deaths: 68, label: "Post-Market Surveillance (Ongoing)" },
    { year: 2036, cases: 170, deaths: 65, label: "Post-Market Surveillance (Ongoing)" },
    { year: 2037, cases: 175, deaths: 63, label: "Post-Market Surveillance (Ongoing)" },
    { year: 2038, cases: 185, deaths: 60, label: "Post-Market Surveillance (Ongoing)" },
    { year: 2039, cases: 190, deaths: 59, label: "Post-Market Surveillance (Ongoing)" },
    { year: 2040, cases: 200, deaths: 57, label: "Post-Market Surveillance (Ongoing)" },
  ];
